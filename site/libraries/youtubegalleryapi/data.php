...
class YouTubeGalleryAPIData
{
	...
	protected static function getVideoData($link, &$blankArray): ?object
	{
		//Returns JSON
		...
		if (isset($j->error)) {
			...
			Factory::getApplication()->enqueueMessage('Youtube Gallery: getVideoData - Response is empty', 'error');
			return null;
		}
		return $j;
	}
