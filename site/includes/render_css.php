...
class YouTubeGalleryRendererCSS extends YouTubeGalleryRenderer
{

protected static function renderCSS(&$theme_row,$instance_id)
{
	$headscript_css='
<style>';
...
';
	...
	if($theme_row->responsive==2)
		$headscript_css.=YouTubeGalleryRendererCSS::getResponsiveCode_CSS($instance_id);
