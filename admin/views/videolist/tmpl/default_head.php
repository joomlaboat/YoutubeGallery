...
?>
<tr>
        <th style="text-align:center;"><?php echo JText::_('COM_YOUTUBEGALLERY_IMAGE'); ?></th>
        <th style="text-align:center;"><?php echo JText::_('COM_YOUTUBEGALLERY_VIDEOSOURCE'); ?></th>
        <th style="text-align:center;"><?php echo JText::_('COM_YOUTUBEGALLERY_VIDEOID'); ?></th>
