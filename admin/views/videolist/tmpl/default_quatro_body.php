...
<?php foreach ($this->items as $i => $item):
    ...
    <tr class="row<?php echo $i % 2; ?>">
                ...
                if (count($images) > 0 and $item->es_imageurl != '') {
                    ...
                    foreach ($images as $img_) {
                        ...
                        if ($i == $index)
                            ...
                            $link = 'changeThumb(' . $item->id . ',\'' . $item->es_imageurl . '\',' . $i . ')';//document.getElementById(\'thumbnail'.$item->id.'\').src=\''.$img.'\'';
        ...
        <td><a href="<?php echo $item->es_link; ?>" target="_blank"><?php echo $item->es_videosource; ?></a></td>
        <td><a href="<?php echo $item->es_link; ?>" target="_blank"><?php echo $item->es_videoid; ?></a></td>
        <td>
